...
socket.bind("10.28.32.28", 2102)
socket2serv = UDPSocket.new
socket2serv.connect("10.28.32.28", 2102)
"Server Local Online!!!"
					...
					case OP
						when 1
							...
							if CONSULTA == nil
								...
								puts
								puts "***** EMAIL CADASTRADO COM SUCESSO *****"
								puts
							elsif CONSULTA != nil
								puts
								puts "***** EMAIL INVALIDO OU EM USO, TENTE NOVAMENTE *****"
								puts
							end
							DBH.disconnect
						when 2
							...
							if CONSULTA == nil
								puts
								puts "***** EMAIL INEXISTENTE, TENTE NOVAMENTE *****"
								puts
							elsif CONSULTA != nil
